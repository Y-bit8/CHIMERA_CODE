...
def pyg_data_generation(df_data,temp,time,metal,solvent,additive,gm,elsi,label,add_fea,add_fea1,condition_features):
    ...
    data_list1=create_pyg(df_data['ligand'],y,temp,time,metal,solvent,additive,gm,elsi,label, add_fea, add_fea1, condition_features)
    data_list2=create_pyg(df_data['product'],y,temp,time,metal,solvent,additive,gm,elsi,label, add_fea, add_fea1, condition_features)
    data_list3=create_pyg(df_data['R1'],y,temp,time,metal,solvent,additive,gm,elsi,label, add_fea, add_fea1, condition_features)
    data_list4=create_pyg(df_data['R2'],y,temp,time,metal,solvent,additive,gm,elsi,label, add_fea, add_fea1, condition_features)
